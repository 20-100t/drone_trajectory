...
#Modified on 18.07.2020 by Vincent Tonini
...
gnome-terminal -e "roslaunch vrpn_client_ros sample.launch server:=10.136.157.95" #the latter is the server address
sleep 3
...
gnome-terminal -e "roslaunch mavros px4.launch fcu_url:="tcp://10.3.141.1:5760"
# gcs_url:="udp://@192.168.4.2:14556" " #fcu_url is the IP of your drone
sleep 3
...
gnome-terminal -e "rosrun trajectory_sender pos_command_in.py"
echo "Launching input node"
#This node prompts the user to input position setpoints in  terminal window.
gnome-terminal -e "rosrun trajectory_sender trajectory.py"
